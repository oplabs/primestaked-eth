...
upgrade-token-local-test :; forge script script/foundry-scripts/UpgradePimeStakedToken.s.sol:UpgradePrimeStakedToken --rpc-url localhost --private-key ${LOCAL_DEPLOYER_PRIVATE_KEY} --broadcast -vvv