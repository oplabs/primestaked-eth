...
import { ISSVViews } from "contracts/interfaces/ISSVViews.sol";
...
contract ForkGoerliTest is Test {
    ...
    // hex"896b5102d5f600aa30687c5cd0088d2e43c3afa7f643600edb12e31cd4b0b2b23e556b33de0168ab94abd4730a18225f",
    //         signature:
    // hex"b2f24a0115546169976cdd8784d6c896febefd58964158f81ab9427e577d5eb055b40f384f4a09b5ff8d2b834277fa861632758a3fcb564dae759922f466a8ea"
    ...
    function test_stakeETH() public {
        ...
        Cluster memory cluster = Cluster(1, 0, 185_426_196_080, true, 2_002_546_440_000_000_000);

        // ISSVViews(0xAE2C84c48272F5a1746150ef333D5E5B51F68763).getBalance(
        //     0x0AaF4B174F1f75542E3BD85030eD9C4a002F9dB9, operatorIds, cluster
        // );

        bytes32 SSV_STORAGE_POSITION = keccak256("ssv.network.storage.main");
        bytes32 hashedCluster = keccak256(abi.encodePacked(AddressesGoerli.NODE_DELEGATOR_NATIVE_STAKING, operatorIds));
        bytes32 firstSlot = keccak256(abi.encodePacked(hashedCluster, SSV_STORAGE_POSITION));
        bytes32 secondSlot = bytes32(uint256(firstSlot) + 1);

        bytes32 data = vm.load(AddressesGoerli.SSV_NETWORK, firstSlot);
