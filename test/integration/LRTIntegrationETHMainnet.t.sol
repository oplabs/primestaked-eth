...
contract LRTIntegrationTestETHMainnet is LRTIntegrationTest {
    function setUp() public override {
        ...
        oethWhale = 0x1a0EBB8B15c61879a8e8DA7817Bb94374A7c4007;

        stEthOracle = 0x4cB8d6DCd56d6b371210E70837753F2a835160c4;
        oethPriceOracle = 0x3D08ccb47ccCde84755924ED6B0642F9aB30dFd2;
        ...
        EIGEN_OETH_STRATEGY = 0x9d7eD45EE2E8FC5482fa2428f15C971e6369011d;
        ...
        oethAddress = 0xA35b1B31Ce002FBF2058D22F30f95D405200A15b;
        ...
        vm.prank(manager);
        lrtDepositPool.transferAssetToNodeDelegator(indexOfNodeDelegator, oethAddress, amountToTransfer);
    }
